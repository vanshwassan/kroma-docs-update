...
The [API3 Market](https://market.api3.org/kroma) lets users access dAPIs on both [Kroma Mainnet](https://market.api3.org/kroma) and [Testnet](https://market.api3.org/kroma-sepolia-testnet).

#### Exploring, selecting and configuring your dAPI

The [API3 Market](https://market.api3.org/kroma) provides a list of all the dAPIs available across multiple chains including testnets. You can filter the list by mainnet or testnet chains. After selecting the chain, you can now search for a specific dAPI by name. Once selected, you will land on the details page (eg ETH/USD on Kroma Testnet) where you can find more information about the dAPI. 
